...
function FAQ() {
    const data = [
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.  On the navigation bar, which is located at the top-left of every page, go to "<Link to="/daily" className="lnk">Daily Goals</Link>".</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/daily" className="lnk">Daily Goals</Link>".</li>
                        <li>2.	At the left white frame with the title "To-do List" click on the bin icon (<RiDeleteBin7Line  style={{color: "#6069FA "}}/>) at the right of the item that you want to remove.</li>
                        <li>3.	Click on the  <button type="submit" className="faqs-btn">Yes</button> option in the pop-up window that will appear. In case you changed your mind click on the
                             <button type="submit" className="faqs-btn">Cancel</button> option.</li>
                    </ol>
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/daily" className="lnk">Daily Goals</Link>".</li>
                        <li>2.	At the left white frame with the title "To-do List" click on the checkbox (<input type="checkbox" disabled/>) at the left of the item that you want to mark as done.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/life" className="lnk">Budget Manager</Link>".</li>
                        <li>2.	Go to the white frame with the title "Add Expense", which is located at the bottom left of the page.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/life" className="lnk">Budget Manager</Link>".</li>
                        <li>2.	Go to the middle white frame with the title "Expenses".</li>
                        <li>3.	Click on the bin icon (<RiDeleteBin7Line style={{color: "#6069FA "}}/>) at the right of the expense that you want to remove.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/notes" className="lnk">Notes</Link>".</li>
                        <li>2.	Go to the last, from the right, white frame that contains the text area with the placeholder "Type to add new note...".</li>
                        <li>3.	Write down your note inside the text area.</li>
                        <li>4.	Click on  <button className="faqs-plus">+</button>, to save your note.</li>
                    </ol>
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top-left of every page, go to "<Link to="/notes" className="lnk">Notes</Link>".</li>
                        <li>2.	Click on the bin icon (<RiDeleteBin7Line style={{color: "#6069FA "}}/>) at the at the bottom, right of the note that you want to remove.</li>
        ...
        },
        {
            ...
            answer: <ol>
                <li>1.	On the navigation bar, which is located located at the top-left of every page, go to "<Link to="/notes" className="lnk">Notes</Link>".</li>
                <li>2.	Click on the button above the notes section with the indication  <FaFont  size={15} style={{color: '#6069FA'}}/>  and a pop up window will appear.</li>
