    ...
    const data = [
        ...
        },
        {
            ...
            answer: <ol>
                        ...
                        <li>2.	At the frame with the title "To-do List" write your to-do in the text area with the placeholder "Write something here".</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top of every page, go to "<Link to="/daily" className="lnk">Daily Goals</Link>".</li>
                        <li>2.	At the frame with the title "To-do List" click on the bin icon (<RiDeleteBin7Line  style={{color: "#6069FA "}}/>) at the right of the item that you want to remove.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top of every page, go to "<Link to="/daily" className="lnk">Daily Goals</Link>".</li>
                        <li>2.	At the frame with the title "To-do List" click on the checkbox (<input type="checkbox" disabled/>) at the left of the item that you want to mark as done.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        ...
                        <li>2.	Go to the frame with the title "Add Expense", which is located at the bottom left of the page.</li>
        ...
        },
        {
            ...
            answer: <ol>
                        <li>1.	On the navigation bar, which is located at the top of every page, go to "<Link to="/life" className="lnk">Budget Manager</Link>".</li>
                        <li>2.	Go to the frame with the title "Expenses".</li>
        ...
        },
        {
            ...
            answer: <ol>
                        ...
                        <li>2.	Go to the frame that contains the text area with the placeholder "Type to add new note...".</li>
        ...
        },
        {
            ...
            answer: <ol>
                <li>1.	On the navigation bar, which is located located at the top of every page, go to "<Link to="/notes" className="lnk">Notes</Link>".</li>
